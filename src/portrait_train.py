...
from tools.common_tools import setup_seed, show_confMat, plot_line, check_data_dir, create_logger
...
if __name__ == '__main__':
    ...
    path_model_101 = os.path.join(BASE_DIR, "..", "..", "data", "pretrained_model", "resnet101-5d3b4d8f.pth")  # bisenet
    # log 输出文件夹配置
