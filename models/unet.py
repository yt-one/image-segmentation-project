...
from tools.helpers import initialize_weights, set_trainable
...
class UNetResnet(nn.Module):
    def __init__(self, num_classes, in_channels=3, backbone='resnet50', freeze_backbone=False, path_model=None):
        super(UNetResnet, self).__init__()
        model = getattr(resnet, backbone)(norm_layer=nn.BatchNorm2d, path_model=path_model)
        ...
        # decoder
        # FIXME: hard code 2048 不适配resnet18/34， resnet18/34的通道是512， resnet50是2048
...
if __name__ == "__main__":
    ...
    fake_img = torch.randn((2, 3, 360, 480))
