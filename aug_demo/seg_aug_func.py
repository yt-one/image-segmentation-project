...
if __name__ == '__main__':
    ...
    aug = A.Compose([
        ...
        # A.Affine(scale=(0.95, 1.1), p=1),       # 缩放
        # A.Affine(translate_percent=0.1, p=1),  # 平移
        # A.Affine(rotate=(-10, 10), p=1),  # 旋转 ["constant","edge","symmetric","reflect","wrap"]
        # A.Affine(shear=(10, 30), p=1),   # 错切
        ...
        # A.LongestMaxSize(max_size=500, p=1),    # 依最常边保持比例的缩放
        # A.OneOf([
